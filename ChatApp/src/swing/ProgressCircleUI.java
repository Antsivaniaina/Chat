...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/chat/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/chat/icon/cancel.png")).getImage();
    }
